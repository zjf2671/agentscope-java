...
Build the Nacos image with auto password initialization.

OPTIONS:
    -v, --version VERSION       Specify the image version tag (default: 3.1.1)
...
EXAMPLES:
    ...
    $0 -v 3.1.1                                 # Build with custom version
...
log_info "Starting Nacos image build process..."
